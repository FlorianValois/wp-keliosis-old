...
<div id="<?= WPK_BTT ?>" class="<?= WPK_PREFIX.'tabs' ?>">
	...
	<div class="<?= WPK_PREFIX.'container' ?>">
        ...
        <!--	Activation -->
        <div id="<?= WPK_BTT.'_Activation' ?>" class="<?= WPK_PREFIX.'card' ?>">
        ...
        <!--Position -->
        <div id="<?= WPK_BTT.'_Position' ?>" class="<?= WPK_PREFIX.'card' ?>">
      ...
      <!-- Styling -->
      <div id="<?= WPK_BTT.'_Styling' ?>" class="<?= WPK_PREFIX.'card' ?>">
